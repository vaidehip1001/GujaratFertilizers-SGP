  ...
  return (
    ...
    >
      ...
      >
        ...
        <header
          className="staggered-menu-header absolute top-0 right-0 w-auto flex items-center justify-end pr-4 sm:pr-6 pt-[1.35rem] bg-transparent pointer-events-none z-20"
          aria-label="Main navigation header"
        >
          <button
            ref={toggleBtnRef}
            className={`sm-toggle relative inline-flex items-center gap-[0.45rem] bg-transparent border-0 cursor-pointer text-base font-semibold leading-none overflow-visible pointer-events-auto ${
        ...
        {/* Logo hidden - using external logo from Header component */}
...
.sm-scope .staggered-menu-header { position: absolute; top: 0; right: 0; width: auto; display: flex; align-items: center; justify-content: flex-end; padding-right: 1rem; padding-top: 1.35rem; background: transparent; pointer-events: none; z-index: 20; }
